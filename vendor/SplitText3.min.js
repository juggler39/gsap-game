                    ...
                    if (l._isSplit)
                        ...
                        l.parentNode._isSplit
                            ...
                            : d ||
                              ...
                              l.parentNode._parent &&
                                  l.parentNode._parent.appendChild(l),
                              m &&
                                  l.parentNode.appendChild(
                                      X.createTextNode(' ')
                                  ),
        ...
        for (
            ...
            if (((l = C.charAt(s)), g && (d = g(C.substr(s), e.specialChars))))
                ...
                '{' === l && '{{LT}}' === C.substr(s, 6)
                    ...
                    ? ((E =
                          ((C.substr(s, 12).split(_) || [])[1] || '').length ||
                          2),
                      (n +=
                          p && ' ' !== l
                              ? i() + C.substr(s, E) + '</' + a + '>'
